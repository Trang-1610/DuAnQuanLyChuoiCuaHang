  ...
  <div class="container qlnl">
      ...
      if ($tblDD && $tblDD->num_rows > 0) {
        ...
        echo "
          ...
          while ($r = $tblDD->fetch_assoc()) {
              ...
              $link = "index.php?page=quanly/quanlydonhang/chitietdonhang&id={$r['MaDon']}";
    ...
    <form action="">
      <div class="text-center mt-4">
        <button class="btn btn-primary"><a href="index.php?page=quanly" class="text-white">Quay lại</a></button>
      </div>
    </form>
  </div>
</body>
